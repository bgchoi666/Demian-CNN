...
def save_results(predictions, config, target, index_today, today, date, ev):
    ...
    result_file = "results_1year/CNN_1D_prob_" + config.file_name + "_" + str(config.far_predict) + "_" + str(config.step_interval) + "_" + str(config.num_steps) + \
